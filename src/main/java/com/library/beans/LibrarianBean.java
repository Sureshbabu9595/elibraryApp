...
public class LibrarianBean {
	...
	public String toString() {
		...
		builder.append("LibrarianBean [id=").append(id).append(", name=").append(name).append(", email=").append(email)
				.append(", password=").append(password).append(", mobile=").append(mobile).append("]");
